- Для генерации текстовых данных был создан класс Conveyor (конвейер), в котором задается размер коллекции ArrayList, которые заполняются случайно либо объектом типо Aplle (яблоко), либо Orange (Апельсин).
